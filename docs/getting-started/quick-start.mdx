...
Ensure your environment is properly configured for Kubernetes, and refer to our documentation for further details.
    ...
    Refer to the [Troubleshooting Guide](../troubleshooting/index.mdx) for more information on resolving issues.
...
- **[Ollama Models](./next-steps/ollama-models.mdx)**: Load a model into Ollama.
