...
[http://localhost:8080](http://localhost:8080)
      ...
      <TabItem value="isolated" label="Isolated">

### Isolated Installation (Manual Setup from GitHub Repo)

If you want to build Open WebUI from source in an isolated environment, follow these instructions.
