...
import DockerInstall from './docker/DockerInstall.md';
import DockerCompose from './docker/DockerCompose.md';
import Podman from './docker/Podman.md';
import ManualDocker from './docker/ManualDocker.md';
import DataStorage from './docker/DataStorage.md';
import DockerUpdating from './docker/DockerUpdating.md';
import Helm from './kubernetes/Helm.md';
import Kustomize from './kubernetes/Kustomize.md';
import Venv from './python/Venv.md';
import CondaUnix from './python/CondaUnix.md';
import CondaWindows from './python/CondaWindows.md';
import HttpsNginx from './https-encryption/Nginx.md';
...
<Tabs>
  ...
  <TabItem value="HttpsNginx" label="Nginx">
    <HttpsNginx />
  </TabItem>

  <TabItem value="HttpsCloudflare" label="Cloudflare">
    *(Content coming soon)*
  </TabItem>
