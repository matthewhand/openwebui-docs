...
In this tutorial, you will learn how to use **Retrieval-Augmented Generation (RAG)** with Open WebUI to load real-world documentation as a knowledge base. We will walk through how to use the latest **OpenWebUI Documentation** as an example for this setup.
...
3. **Locate the Markdown Files**:
   - In the extracted folder, locate all files with `.md` or `.mdx` extensions. 
...
5. **Upload the Files**:
   - Drag and drop the `.md` and `.mdx` files (tip: search for `*.md*`) from the extracted folder into the **OpenWebUI Documentation** knowledge base.

</TabItem>

<TabItem value="models" label="Create and Configure the Model">
...
<TabItem value="examples" label="Examples and Usage">
