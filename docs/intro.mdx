...
If you want to disable login for a single-user setup, set [`WEBUI_AUTH`](../../getting-started/advanced-topics/EnvConfig) to `False`. This will bypass the login page.
